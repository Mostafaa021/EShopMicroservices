...
namespace Catalog.API.Data
{
    public class CatalogInitialData : IInitialData
    {
        ...
        {
            // Create Session of LightWeight
            using var session = store.LightweightSession();

            // Check If PostgreSql Already have product Data
        ...
        private static IEnumerable<Product> GetPreconfiguredProducts() => new List<Product>()
            {
                new Product()
                {
                    ...
                    Descreption = "This phone is the company's biggest change to its flagship smartphone in years. It includes a borderless.",
                ...
                new Product()
                {
                    ...
                    Price = 470.00M,
                    Category = new List<string> { "White Appliances" , "Smart Phone" }
                },
                new Product()
                {
